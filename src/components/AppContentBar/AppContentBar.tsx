...
const Dropdown = ({ header, selections }) => {
  ...
  return (
    <div classNameName='dropdown'>
      <div onClick={() => setExpanded(!expanded)} classNameName='dropdown-header'>
        <ChevronIcon expanded={expanded} />
        <h5
          classNameName={expanded ? 'dropdown-header-text-selected' : 'dropdown-header-text'}
        >
          {header}
        </h5>
        <FaPlus size='12' classNameName='text-accent text-opacity-80 my-auto ml-auto' />
      </div>
      {expanded &&
        selections &&
...
const ChevronIcon = ({ expanded }) => {
  ...
  return expanded ? (
    <FaChevronDown size='14' classNameName={chevClassName} />
  ) : (
    <FaChevronRight size='14' classNameName={chevClassName} />
  );
};

const TopicSelection = ({ selection }) => (
  <div classNameName='dropdown-selection'>
    <BsHash size='24' classNameName='text-gray-400' />
    <h5 classNameName='dropdown-selection-text'>{selection}</h5>
  </div>
);

const ChannelBlock = ({title}) => (
  <div classNameName='channel-block'>
    <h5 classNameName='channel-block-text'>{title}</h5>
  </div>
);
